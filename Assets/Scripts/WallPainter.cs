...
public class WallPainter : MonoBehaviour
{
    ...
    private bool IsWall(ARPlane plane)
    {
        ...
        // Android/ARCore: classification ist meist None → wir nehmen vertikal als Wand
        if (plane.alignment != PlaneAlignment.Vertical)
            return false;

        // Wenn classification vorhanden UND nicht None, dann nur Wall zulassen
    ...
    public void SetWallColor(Color c)
    {
        ...
        // direkt alle schon erkannten Planes updaten
        PaintExistingPlanes();
    }
